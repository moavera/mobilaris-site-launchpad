          ...
          <div className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                ...
                className="text-white text-base font-medium transition-opacity hover:opacity-80 flex items-center gap-1"
              >
                {link.label}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-white text-base font-medium border-2 border-white px-6 py-2 rounded hover:bg-white hover:text-foreground transition-all"
            >
              Contact us
            </a>
          </div>
