...
export const MobileFirst = () => {
  return <section id="mobile-access" className="py-20 bg-muted/30 scroll-mt-20 group">
      <div className="container mx-auto px-4">
        {/* Mobile First */}
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16 animate-fade-in-up">
          {/* Image */}
          <div className="relative flex justify-center">
            <img src={mobileAppImage} alt="Mobilaris Site mobile app showing gas cylinder tracking" className="h-auto w-64 md:w-72 rounded-3xl shadow-2xl" />
          </div>
