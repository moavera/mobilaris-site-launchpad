    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16 animate-fade-in-up">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Everything at Your Fingertips</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold text-center mb-4">Flexible Deployment Solutions</h3>
