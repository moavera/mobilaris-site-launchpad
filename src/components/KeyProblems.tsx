        ...
        <div className="md:hidden">
          <div className="overflow-hidden -mx-4" ref={emblaRef}>
            <div className="flex gap-4 px-4">
              {problems.map((problem, index) => <div key={index} className="flex-[0_0_85%] min-w-0">
                  <Card className="p-8 h-full hover:shadow-elegant transition-all duration-300 border-border/50">
                    <div className="mb-6">
