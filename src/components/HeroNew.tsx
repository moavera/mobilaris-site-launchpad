        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl animate-fade-in-up">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 leading-[1.15] tracking-tight">
              <span className="block whitespace-nowrap">Real-time awareness for mining</span>
              <span className="block whitespace-nowrap mt-3">and critical infrastructure</span>
            </h1>
