...
export const HeroNew = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      {/* Video Background - Right-aligned and smaller on desktop */}
      <video autoPlay loop muted playsInline className="absolute inset-0 md:inset-auto md:right-[5%] md:top-1/2 md:-translate-y-1/2 w-full md:w-[50%] h-full md:h-[75%] object-cover object-center rounded-none md:rounded-2xl">
