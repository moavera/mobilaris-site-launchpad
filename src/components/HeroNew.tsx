        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl animate-fade-in-up">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 leading-[1.15] tracking-tight">
              <span className="block whitespace-nowrap">Real-time awareness</span>
              <span className="block whitespace-nowrap mt-3">for mining and critical infrastructure</span>
            </h1>
            
            {/* Key Message */}
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
              <span className="text-foreground font-bold">Mobilaris Site™</span> provides a real-time overview of people, vehicles and assets – helping mining and industrial operations work safer, smarter and more efficiently. 
            </p>
