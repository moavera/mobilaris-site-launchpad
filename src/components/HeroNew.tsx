        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl animate-fade-in-up">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
              <span className="text-foreground font-bold">Mobilaris Site™</span> provides a shared real-time view of people, vehicles and assets – supporting safer coordination in safety-critical environments.
            </p>
