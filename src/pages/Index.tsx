  ...
  return <main className="min-h-screen bg-background font-galano">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden bg-black">
        ...
        <div className="container mx-auto px-6">
          <a href="https://site.mobilaris.se/" className="flex flex-col items-center text-center gap-8 max-w-5xl mx-auto animate-fade-in-up bg-card/60 backdrop-blur-xl border border-border/50 rounded-3xl p-12 shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:border-primary cursor-pointer">
            {/* New Release Badge */}
            <div>
